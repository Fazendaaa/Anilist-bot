...
const animeSearch = anime => {
    ...
    if ('' != anime) return _nani2.default.get(`anime/search/${anime}`).then(data => replyAnime(data[0])).catch(error => {
...
const characterSearch = character => {
    ...
    if ('' != character) return _nani2.default.get(`character/search/${character}`).then(data => replyCharacter(data[0])).catch(error => {
...
const staffSearch = search => {
    ...
    if ('' != search) return _nani2.default.get(`staff/search/${search}`).then(data => replyStaff(data[0])).catch(error => {
...
const studioSearch = search => {
    ...
    if ('' != search) return _nani2.default.get(`studio/search/${search}`).then(data => replyStudio(data[0])).catch(error => {
